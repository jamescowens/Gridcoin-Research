    ...
    Rectangle {
            ...
            TableFooter {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        Layout.fillHeight: true
                        implicitWidth: 30
                        icon.source: MMPTheme.themeSelect("icons/generic/ic_remove_light.svg","icons/generic/ic_remove_dark.svg")
                        background: Item{}
                    }
                    Rectangle {
                        color: addressListRect.border.color
        ...
        Item {
            ...
            Button {
                ...
                icon.source: MMPTheme.themeSelect("icons/buttons/ic_btn_verify_light.svg","icons/buttons/ic_btn_verify_dark.svg")
                anchors {
                    verticalCenter: parent.verticalCenter
                    right: parent.right
                    rightMargin: 10
